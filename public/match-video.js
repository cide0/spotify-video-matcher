            ...
            if(google_api_keys.length === 0){
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        music_video_element.src = "https://www.youtube-nocookie.com/embed/" + video_id + "?autoplay=1&mute=1&vq=hd1080&enablejsapi=1&version=3&playerapiid=ytplayer&cc_lang_pref=en&iv_load_policy=3&loop=1&playlist=" + video_id + "&start=" + Math.trunc((song_progress + 1400) / 1000) + "&origin=" + encodeURIComponent(window.location.origin);
                    },
                    ...
                    if((h === 10 && m === 30)
                        ...
                        if(!rickrolled){
                            if(music_video_element.src !== "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1&mute=1&vq=hd1080&enablejsapi=1&controls=0&version=3&playerapiid=ytplayer&cc_lang_pref=en&iv_load_policy=3&loop=1&playlist=dQw4w9WgXcQ&origin=" + encodeURIComponent(window.location.origin)){
                                music_video_element.src = "https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?autoplay=1&mute=1&vq=hd1080&enablejsapi=1&controls=0&version=3&playerapiid=ytplayer&cc_lang_pref=en&iv_load_policy=3&loop=1&playlist=dQw4w9WgXcQ&origin=" + encodeURIComponent(window.location.origin);
                            }
